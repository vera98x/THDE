...
namespace UARTLib {
	...
	void HardwareUART::begin() {
		...
		///< 115200: 45
		unsigned long long int masterClock = 84000000;
		hardwareUSART->US_BRGR = (masterClock / baudrate) / 16;
		hwlib::cout << "0x" << hwlib::hex << hardwareUSART->US_BRGR << hwlib::endl;
		///< No parity, normal channel mode. Use a 8 bit data field.
		hardwareUSART->US_MR = UART_MR_PAR_NO | UART_MR_CHMODE_NORMAL | US_MR_NBSTOP_1_BIT |
